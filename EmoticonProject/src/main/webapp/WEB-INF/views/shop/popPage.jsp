						...
						<ol class="list_double">
							<c:forEach items="${deslist}" var="product" varStatus="status">
								<li>
									...
									<a class="link_double double_img" aria-lable="이모티콘" href="/shop/datailpage?p_no=${product.p_no}">
										<div class="area_doubleemoticon">
											<img src="../resources/preview/<c:out value="${product.p_image}"/>" height="100px" 
											class="img_emot img_default" alt="pop">
										</div>
									</a>
								</li>
							</c:forEach>
