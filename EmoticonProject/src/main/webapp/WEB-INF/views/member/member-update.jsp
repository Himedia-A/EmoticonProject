		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3">
				<div class="block text-center">
					...
					<form class="text-left clearfix" action="index">
						...
						<div class="text-center">
							<input type="submit" class="btn btn-main text-center" value="Modification">
						</div>
					</form>
					<p class="mt-20">변경하지 않겠습니까?<a href="mypage">Going backwards</a></p>
					<p><a href="memberupdate"></a></p>
				</div>
			</div>
		</div>
	</div>
