						...
						<li class="dropdown profile-nav dropdown-slide">
							...
							<div class="dropdown-menu profile-dropdown">
								...
								<div class="media">
									...
									<ul class="text-center profile-buttons"></ul>
								</div>
						</li>
					</ul>
				</div>
	...
	<nav class="navbar-navigation">
		<div class="container">
			<div class="navbar-header">
				...
				<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-targer="#navbar"
			...
			<div id="navbar" class="navbar-collapse collapse text-center">
				<ul class="nav navbar-nav">
					<!-- Home -->
					<li class="home-tab">
						<a href="/shop/" style="font-size: large; text-decoration: underline; text-underline-offset: 8px; text-decoration-thickness: 2px;" >홈</a>					
					</li>
					<!-- /Home -->
					<!-- 신규 -->
					<li class="new-tab">
				...
				<div class="dashboard-wrapper dashboard-user-profile">
					<div class="media">
						<div class="pull-left text-center" href="#">
							&nbsp;<img class="media-object user-img" src="../resources/images/profile-img.png" alt="Image">
						</div>
						<c:if test="${member != null}">
						<div class="media-body">
						...
						<button class="custom-btn btn-4" id=memberUpdateBtn type="button">회원정보 수정</button>
						<button class="custom-btn btn-4" id=memberDeleteBtn><span>회원탈퇴</span></button>
						</div>
					</div>
				</div>
			</div>
